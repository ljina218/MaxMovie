...
public class MovieReserationView extends JPanel{
	...
	JLabel						jl_south_Allseat		= new JLabel();
	...
	public void initDisplay() {
		...
		jl_south_Allseat.setBounds(900, 710, 150, 20);
		...
		jl_south_Allseat.setHorizontalAlignment(JLabel.CENTER);
		 ...
		 * jl_south_Allseat.setText(????);
		 * jl_south_totalPay.setText(????);
		 * 예시)
		 * jl_south_Allseat.setText("A2, A3, A4");  <- 아마 4개 이후에는 \n하는게 좋을꺼같습니다람쥐
		 ...
		 * jbt_goPayChoice.setEnabled(false);
		 * 
		 * 좌석선택이 인원수와 동일하진 않지만 하나라도 된경우(이벤트시 계속 체인지)
		 * jl_south_Allseat.setText("");
		 * jl_south_totalPay.setText("");
		 * 
		 * 
